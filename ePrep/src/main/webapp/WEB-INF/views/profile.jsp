...
<body class="">
					...
					<div class="flex-column">
						<div class="tab-content">
								...
								<div class="content">
									...
									<div class="row">
										...
										<div class="col">
											...
											<button class="button  mt-3" data-toggle="modal"
												data-target="#add-images">
												<i class="fa fa-fw fa-camera"></i> <span> <c:choose>
														<c:when test="${not empty user.image}">
										...
										<div class="tab-pane fade" id="edit-profile" role="tabpanel"
											...
											<form:form action="updatecontact" modelAttribute="address"
												...
												<div class="fieldset group-select" id="conactinfo">
													...
													<div class="customer-name">
														<div class="input-box">
															...
															<div class="input-box1">
																<form:input type="text" id="firstname" path="user.fname"
																	value="${user.fname}"
																	class="input-text required-entry mb-3" />
															</div>
														</div>
														...
														<div class="input-box name-lastname">
															<label for="lastname">Last Name<span
																class="required">*</span></label>
															<div class="input-box1">
																<form:input type="text" id="lastname" path="user.lname"
																	value="${user.lname}"
																	class="input-text required-entry mb-3" />
															</div>
														</div>
													...
													<form:input class="input-text required-entry" path="phone"
												...
												<div class="fieldset group-select">
													...
													<div class="field">
														<div class="input-box">
															...
															<form:input class="input-text required-entry mb-3"
							...
							<div class="tab-pane fade" id="dashboard" role="tabpanel"
										...
										<li class="nav-item dropdown"><a
											...
											<div class="dropdown-menu" aria-labelledby="dropdown08">
												<a class=" nav-link dropdown-item" href="#"
													data-toggle="modal" data-target="#addCraneOpPre">Crane
													Op Pre</a> <a class="dropdown-item" href="#"
													data-toggle="modal" data-target="#addCraneOpPost">Crane
													Op Post</a> <a class="dropdown-item" href="#"
													data-toggle="modal" data-target="#addDriverPre">Driver
													Pre</a> <a class="dropdown-item" href="#" data-toggle="modal"
													data-target="#addDriverPost">Driver Post</a> <a
													class="dropdown-item" href="#" data-toggle="modal"
													data-target="#addTechPre">Tech Pre</a> <a
													class="dropdown-item" href="#" data-toggle="modal"
													data-target="#addTechPost">Tech Post</a>
											</div></li>
										...
										<li class="nav-item dropdown"><a
											...
											<div class="dropdown-menu" aria-labelledby="dropdown08">
												<a class="dropdown-item" href="#">Incident</a> <a
													...
													class="dropdown-item" href="#" data-toggle="modal"
													data-target="#addRepairOrder">Repair Order</a>
											</div></li>
								...
								<div class="tab-content">
													...
													<c:if test="${works.hasPrevious()}">
														<li class='page-item'><a class="page-link"
															href="profile?page=0&size=${works.getSize()}#jobs"> <i
																class="fa fa-angle-double-left margin-5px-left xs-display-none "></i>
														</a></li>
														<li class='page-item'><a class="page-link"
									...
									<div class="tab-pane fade" id="workorders" role="tabpanel"
										...
										Page ${repairs.getNumber()+1} of ${repairs.totalPages} showing
										${repairs.content.size()} of all ${repairs.getTotalElements()}
										Users
										<table class="table ">
											<thead class="thead-dark">
												<tr>
											...
											<tbody>
												<c:forEach var="rep" items="${repairs.content}">
													<tr>
														<td>${rep.id}</td>
														<td>${rep.work}</td>
														<td>${rep.equipment}</td>
														<td>${rep.getInitiator().fname }
															${rep.getInitiator().lname }</td>
														<td>${rep.problemDescription}</td>
														<td>${rep.status}</td>
										...
										<c:if test="${repairs.hasContent()}">
											<div class="pages">
												<ul class="pagination">
													...
													<c:if test="${repairs.hasPrevious()}">
														<li class='page-item'><a class="page-link"
															href="profile?page=0&size=${repairs.getSize()}#jobs">
																<i
																class="fa fa-angle-double-left margin-5px-left xs-display-none "></i>
														</a></li>
														<li class='page-item'><a class="page-link"
															href="profile?page=${prev}&size=${repairs.getSize()}#jobs">
																<i
																class="fa fa-long-arrow-alt-left margin-5px-right xs-display-none"></i>
																Prev
														</a></li>
													</c:if>
													<c:forEach var="i" begin="0" end="${repairs.totalPages -1}">
														<li
															class='page-item <c:if test="${repairs.getNumber() eq i || (empty repairs.getNumber() && i eq 0)}">active</c:if>'>
															<a class="button primary small"
															href="profile?page=${i}&size=${repairs.getSize()}#jobs">${i+1}
														</a>
														</li>

													</c:forEach>
													<c:if test="${repairs.hasNext()}">
														<li class='page-item'><a class="page-link"
															href="profile?page=${repairs.getNumber() + 1}&size=${repairs.getSize()}#jobs">Next
																<i
																class="fa fa-long-arrow-alt-right margin-5px-left xs-display-none "></i>
														</a></li>
														<li class='page-item'><a class="page-link"
															href="profile?page=${repairs.totalPages -1}&size=${repairs.getSize()}#jobs">
																<i
																class="fa fa-angle-double-right margin-5px-left xs-display-none "></i>
														</a></li>
													</c:if>
							...
							<div class="tab-pane fade" id="equipment" role="tabpanel"
								...
								<div
									class="d-flex n flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 border-bottom">
									<h1 class="h2">Equipment</h1>
									<div class="ml-3 dropdown show">
										<a class="button dropdown-toggle" href="#" role="button"
											id="dropdownMenuLink" data-toggle="dropdown"
											aria-haspopup="true" aria-expanded="false">ADD </a>

										<div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
											<a class=" dropdown-item" href="#" data-toggle="modal"
												data-target="#addHead">Add Head</a> <a class="dropdown-item"
												href="#" data-toggle="modal" data-target="#addTrailer">Add
												Trailer</a> <a class="dropdown-item" href="#"
												data-toggle="modal" data-target="#addCrane">Add Crane</a> <a
												class="dropdown-item" href="#" data-toggle="modal"
												data-target="#addTruck">Add Truck</a> <a
												class="dropdown-item" href="#" data-toggle="modal"
												data-target="#addCar">Add Car</a>

										</div>
									</div>
									<a class="button" href="#" data-toggle="modal"
										data-target="#equipSearch" tabindex="-1" aria-disabled="true">Search</a>
									<div class="btn-toolbar mb-2 mb-md-0"></div>
								</div>
								...
								<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
									...
									<li class="nav-item" role="presentation"><a class="button"
										id="pills-heads-tab" data-toggle="pill" href=""
										data-target="#pills-heads" role="tab"
										aria-controls="pills-heads" aria-selected="false">Heads</a></li>


									<li class="nav-item" role="presentation"><a
										class=" button" id="pills-cranes-tab" data-toggle="pill"
										href="#pills-cranes" role="tab" aria-controls="pills-cranes"
										aria-selected="false">Cranes</a></li>


									<li class="nav-item" role="presentation"><a
										class=" button" id="pills-cars-tab" data-toggle="pill"
										href="#pills-cars" role="tab" aria-controls="pills-cars"
										aria-selected="false">Cars</a></li>

									<li class="nav-item" role="presentation"><a class="button"
										id="pills-trucks-tab" data-toggle="pill" href="#pills-trucks"
										role="tab" aria-controls="pills-trucks" aria-selected="false">Trucks</a></li>

									<li class="nav-item" role="presentation"><a class="button"
										id="pills-trailers-tab" data-toggle="pill"
										href="#pills-trailers"false">Trailers</a></li>


									<li class="nav-item" role="presentation"><a
										class=" button" id="pills-accessories-tab" data-toggle="pill"
										href="#pills-accessories" role="tab"
										aria-controls="pills-accessories" aria-selected="false">Accessories</a></li>

								</ul>
								<div class="tab-content" id="pills-tabContent">

									<div class="tab-pane fade" id="pills-heads" role="tabpanel"
										aria-labelledby="pills-home-tab">

										<h1>Heads</h1>

										Page ${heads.getNumber()+1} of ${heads.totalPages} showing
										${heads.content.size()} of all ${heads.getTotalElements()}
										equipment
										<table class="table">
											<thead class="thead-dark">
												<tr>
													<th scope="col"><i class="fa fa-id-badge"></i> Name</th>
													<th scope="col"><i class="fa fa-puzzle-piece"></i>
														Type</th>
											...
											<tbody>
												<c:forEach var="heads" items="${heads.content}">
													<tr>
														<td>${heads.headname}</td>
														<td>${heads.equipType}</td>
														<td>${heads.location}</td>
														<td>${heads.getStatus()}</td>
														<td><a class="button edit-item" href="#"
															data-toggle="modal" data-target="#heads${heads.id}"
															title="Heads Info" class="edit-bnt" href="#"><i
																class="fa fa-pencil"></i></a></td>
									...
									<div class="tab-pane fade" id="pills-cranes" role="tabpanel"
									...
									<div class="tab-pane fade" id="pills-trucks" role="tabpanel"
										aria-labelledby="pills-contact-tab">
										<h1>Trucks</h1>
									...
									<div class="tab-pane fade" id="pills-trailers" role="tabpanel"
										aria-labelledby="pills-contact-tab">
										<h1>Trailers</h1>
									...
									<div class="tab-pane fade" id="pills-accessories"
	...
	<c:forEach var="head" items="${heads.content}">
		<div class="modal fade" id="heads${head.id}">
			<div class="modal-dialog modal-dialog-centered modal-lg">
				<div class="modal-content">
					<div class="modal-header">Head Info</div>
					<!-- Modal body -->
					<div class="modal-body">
						<form:form action="addhead" modelAttribute="head"
							method="post" id="form-validate">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="addwork" modelAttribute="work" method="post"
						...
						<div class="input-box">
							<label for="productioncompany">Production Company<em
								class="required">*</em></label> <br>
							<form:input class="input-text required-entry"
								path="productioncompany" value=""
						...
						<select id="inputCraneOp" class="form-control">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form action="addhead" method="POST" modelAttribute="head">
						...
						<div class="input-box">
							<label for="location">Head Location<em class="required">*</em></label>

							<form:input class="input-text required-entry" path="location"
								value="" placeholder="Enter Head Location" />
						</div>
						...
						<div class="input-box name-lastname">
							<label for="status">Please select status <span
								class="required">*</span></label>
							<form:select path="status" defaultvalue="${head.getStatus()}"
								class="col-md-12">
	...
	<div class="modal fade" id="addCraneOpPre" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Crane Operator
						Pre Report</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
	...
	<div class="modal fade" id="addCraneOpPost" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
	...
	<div class="modal fade" id="addTechPre" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Technician Pre
						Report</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
	...
	<div class="modal fade" id="addTechPost" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Technician Post
						Report</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
	...
	<div class="modal fade" id="addDriverPre" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Driver Pre
						Report</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
	...
	<div class="modal fade" id="addDriverPost" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Driver Post
						Report</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
	...
	<div class="modal fade" id="addRepairOrder" tabindex="-1" role="dialog"
		aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="exampleModalLabel">Repair Order</h5>
				</div>
				<div class="modal-body">
					<form:form action="addrepairorder" method="POST"
						modelAttribute="repair">

						<input name="initiator" type="hidden" value="${user.id}">
						...
						<select id="inputState" class="form-control">
							...
							<c:forEach items="${works.content}" var="p">
								<option>${p.jobname}</option>
							</c:forEach>
