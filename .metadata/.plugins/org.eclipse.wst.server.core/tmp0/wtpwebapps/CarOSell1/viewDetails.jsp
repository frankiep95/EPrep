...
<body>
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav">
			<li class="nav-item"><a class="nav-link" href="newCars">New
					Vehicles</a></li>
			<li class="nav-item"><a class="nav-link" href="usedCars">Used
					Vehicles</a></li>
			<li class="nav-item"><a class="nav-link" href="loginServlet">Account</a></li>
		</ul>
	</div>
	</nav>
		...
		<div class="table-responsive">
			<table class="table">
				<tr>
					...
					<td><img height="100px" width="200px" src="<c:out value="${car.images[0]}"/>" /></td>
